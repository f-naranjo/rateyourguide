    ...
    render() {
        if (this.props.tour) {
            ...
            if (rates.length === 0) {
                ...
                mediumrate = Math.round((rates.reduce((ac, cu) => {
                    return ac + cu
                }, 0) / rates.length))
            }
                        ...
                        <div className="tour-info">
                            ...
                            <div className="admin-btns">
                                <div className="tour-btns">
                                    ...
                                    ><i className="fas fa-edit"></i> EDITAR TOUR</Link>
                                    ...
                                    ><i className="fas fa-trash-alt"></i> ELIMINAR TOUR</Link>
                                </div>
                                <div className="sessions-btns">
                                    <Link className="admin-btn create"
                                        to={{
                                            pathname: '/guides/adminpanel/sessions/create',
                                            state: this.props.tour,
                                        }}
                                    ><i className="far fa-calendar-plus"></i> CREAR SESIONES</Link>
                                    <Link className="admin-btn manage"
                                        to={{
                                            pathname: '/guides/adminpanel/sessions/edit',
                                            state: { 
                                                tour: this.props.tour,
                                                user: this.props.user,
                                            }
                                        }}
                                    ><i className="far fa-calendar-plus"></i> EDITAR SESIONES</Link>
